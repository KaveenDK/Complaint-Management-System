...
<div class="glass mx-auto">
    <span class="employee-icon mb-2"><i class="bi bi-person-badge"></i></span>
    <div class="dashboard-title mb-2">Employee Dashboard</div>
    <div class="welcome-msg mb-4">
        Welcome, <b><%= user.getFullName() %></b>
    </div>
    <div class="d-grid gap-3 mb-3">
        <a href="complaintForm.jsp" class="btn btn-purple btn-lg">Submit Complaint</a>
        <a href="../ComplaintServlet" class="btn btn-outline-purple btn-lg">View Complaints</a>
